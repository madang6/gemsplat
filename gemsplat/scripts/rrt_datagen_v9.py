...
class RRT:
    ...
    def is_collision(self, point):
        #NOTE Commented stuff works, just trying something new below it
        ...
        # else:
        #     return False
        # Check if the point is within collision_distance of any obstacle point
        # Combine the 2D point with the altitude to create a 3D point
